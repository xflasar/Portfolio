			...
			<div className="skills-container">
				...
				<section className="skills-top">
					<div className="skill-cloud-container">
						<div
							className={
								skillSelectedProjects !== null
									? antiSkillsBoxCollision
										? "skill-cloud non-main box-collision-active"
										: "skill-cloud non-main"
									: antiSkillsBoxCollision
									? "skill-cloud box-collision-active"
									: "skill-cloud"
							}
						>
							{skillsData.map((skill) => {
								return (
									<div
										...
										className={
											skillSelected === skill.node.skillName
												? "skill active"
												: "skill"
										}
                    ...
                    <div className="skill-overlay">
										...
										<span className="experience">
											{calculateExperience(skill.node.skillStartDate)}
										</span>
									</div>
								);
							})}
